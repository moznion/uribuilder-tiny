...
public class URIBuilderTinyTest {
  ...
  public void shouldGetURIInstanceByManual() {
    ...
    URI got =
        new URIBuilderTiny()
            ...
            .build();
    assertEquals(
        "https://java.example.com:8080/foo/bar/buz/qux?hoge=fuga&piyo=hogera#frag", got.toString());
  }
  ...
  public void shouldGetURIInstanceByURIInitialValue() {
    URI got =
        new URIBuilderTiny(URI.create("https://java.example.com/foo/bar"))
            .setPort(8080)
            .appendPaths(Arrays.asList("buz", "qux"))
            .addQueryParameter("hoge", "fuga")
            .addQueryParameter("piyo", "hogera")
  ...
  public void testEmptyPort() {
    URI got = new URIBuilderTiny().setScheme("http").setHost("java.example.com").build();
  ...
  public void testForTrailingSlash() {
    URI got =
        new URIBuilderTiny().setScheme("http").setHost("java.example.com/").setPort(8080).build();
  ...
  public void testForQueryStringOfInitValue() {
    URI got = new URIBuilderTiny("http://java.example.com?foo=bar&buz=qux").setPort(8080).build();
    assertEquals("http://java.example.com:8080?buz=qux&foo=bar", got.toString());
  }

  @Test
  public void testForAmbiguousQueryStringOfInitValue() {
    URI got = new URIBuilderTiny("http://java.example.com?foo&buz=qux").setPort(8080).build();
  ...
  public void shouldNPEWhenPassNullIntoSetPaths() {
    assertThrows(
        NullPointerException.class, () -> new URIBuilderTiny().setPaths((List<Object>) null));
  }

  @Test
  public void shouldNPEWhenPassNullIntoAppendPaths() {
    assertThrows(
        NullPointerException.class, () -> new URIBuilderTiny().appendPaths((List<String>) null));
  }
  ...
  public void shouldNPEWhenPassNullIntoSetQueryParameterOfKey() {
    assertThrows(
        NullPointerException.class, () -> new URIBuilderTiny().setQueryParameter(null, "value"));
  }

  @Test
  public void shouldNPEWhenPassNullIntoSetQueryParameterOfValue() {
    assertThrows(
        NullPointerException.class, () -> new URIBuilderTiny().setQueryParameter("key", null));
  }
  ...
  public void shouldNPEWhenPassNullIntoAddQueryParameterOfKey() {
    assertThrows(
        NullPointerException.class, () -> new URIBuilderTiny().addQueryParameter(null, "value"));
  }

  @Test
  public void shouldNPEWhenPassNullIntoAddQueryParameterOfValue() {
    assertThrows(
        NullPointerException.class, () -> new URIBuilderTiny().addQueryParameter("key", null));
  }
  ...
  public void shouldNPEWhenPassNullIntoVarargAppendPaths() {
    assertThrows(
        NullPointerException.class, () -> new URIBuilderTiny().appendPaths((Object[]) null));
  }
  ...
  public void testForSchemeAndPathsCase() {
    URI got = new URIBuilderTiny().setScheme("http").appendPaths("foo", "bar").build();
  ...
  public void shouldSetQueryParamEvenIfAnyTypeByMap() {
    ...
    URI got = new URIBuilderTiny("http://example.com").setQueryParameters(queryParameters).build();
  ...
  public void shouldSetQueryParamEvenIfAnyType() {
    URI got =
        new URIBuilderTiny("http://example.com").setQueryParameter("foo", new Foo("foo")).build();
    assertEquals("http://example.com?foo=foo", got.toString());
  }
  ...
  public void shouldAddQueryParamEvenIfAnyTypeByMap() {
    ...
    URI got = new URIBuilderTiny("http://example.com").addQueryParameters(queryParameters).build();
    assertEquals("http://example.com?foo=foo&hoge=fuga&piyo=1", got.toString());
  }
  ...
  public void shouldAddQueryParamEvenIfAnyType() {
    ...
    URI got =
        new URIBuilderTiny("http://example.com")
            .addQueryParameter("hoge", "fuga")
